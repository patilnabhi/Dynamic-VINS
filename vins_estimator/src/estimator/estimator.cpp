...
Estimator::Estimator(const rclcpp::Logger& logger) 
    : logger_(logger), 
    f_manager_{logger_, Rs_}
{
    RCLCPP_INFO(logger_, "init begins");
    clearState();
}
...
void Estimator::setParameter()
{
    ...
    featureTracker_.readIntrinsicParameter(CAM_NAMES);
    // if (FISHEYE)
    // {
    ...
    // }
    featureTracker_.initGridsDetector();
}
